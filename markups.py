...
Пример: /add АРХИПРО проект Invisible (ТЗ)
<b>/add ключ - Добавить сообщение в закладки
/get ключ - Показать сообщение из закладок
/remove ключ - Удалить закладку
/list - Список закладок</b>
